...
<html lang="en">
  <head>
    <title>HD Interior - Home Page</title>
    <meta charset="utf-8">
		...
		<section class="ftco-section ftc-no-pb" id="about">
			<div class="container">
	          ...
	          <div class="heading-section mb-5 pl-md-5 heading-section-with-line">
	          	<div class="pl-md-5">
		          	<span class="subheading" style="color: red">About</span>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <a href="#" style="margin-bottom:70px;" id="myBtn"><span class="icon-whatsapp"></span></a>
    <a href="#" id="myBtn"><span class="icon-instagram"></span></a>
  ...
  <script type="text/javascript">
    ...
    document.querySelectorAll('a[href^="#desc"]').forEach(anchor => {
